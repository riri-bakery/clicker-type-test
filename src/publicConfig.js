...
export const brandConfig = Object.freeze({
  ...
  resultDisclaimer: "이 결과는 리리베이커리가 현재 보유한 37개 스위치 안에서 추천합니다. 스위치 속성과 캐릭터 해석의 연결은 리리베이커리의 주관적인 판단이며, 실제 제작 전에는 재고와 직접 확인한 키감을 함께 고려해 주세요.",
  ...
  meta: {
    pageTitle: "캐릭터 클릭 타입 테스트 · 축BTI by 꾹꾹이 쿠키 클리커",
    pageDescription: "내 캐릭터는 어떤 클릭 타입일까? 캐릭터의 성격과 분위기를 바탕으로 어울리는 소리와 촉감을 찾아보세요.",
    ogTitle: "내 캐릭터는 어떤 클릭 타입일까?",
    ogDescription: "캐릭터의 성격과 분위기를 바탕으로 어울리는 소리와 촉감을 찾아보세요.",
    twitterCard: "summary"
  }
});

export const categoryMessages = Object.freeze({
  "겉인상": "처음 마주쳤을 때의 인상을 살펴보고 있어요.",
  "감정 표현": "감정이 드러나는 방식을 살펴보고 있어요.",
  "행동 방식": "움직임과 반응 방식을 살펴보고 있어요.",
  "대인 태도": "다른 사람을 대하는 방식을 살펴보고 있어요.",
  "힘의 무게": "캐릭터가 가진 힘의 무게를 살펴보고 있어요.",
  "속내": "속마음이 드러나는 정도를 살펴보고 있어요.",
  "소리": "캐릭터에게 어울리는 소리를 찾고 있어요.",
  "성격의 촉감": "성격을 손끝 감각으로 바꾸고 있어요.",
  "온도": "캐릭터가 가진 온도를 살펴보고 있어요.",
  "이야기 속 존재감": "이야기 속에서 차지하는 자리를 살펴보고 있어요.",
  "숨은 모습": "오래 지켜봐야 보이는 면을 살펴보고 있어요.",
  "경계 반응": "불편한 상황에서 경계를 표현하는 방식을 살펴보고 있어요.",
  "첫 반응": "예상 밖의 상황에 반응하는 속도와 움직임을 살펴보고 있어요."
});
