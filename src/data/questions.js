...
export const DEFAULT_QUESTIONS = [
  {
    id: "Q1", category: "", enabled: true, scope: "outer", weight: 1,
    axisWeights: { quiet: 0.05, clarity: 0.06, presence: 0.04 },
    question: "이 캐릭터의 첫등장은 어떤 인상일까?",
    answers: [
      answer("A", "존재감이 옅고 조용하다.", { quiet: 95, clarity: 25, presence: 10 }),
      answer("B", "조용하지만 왠지모르게 눈길이 간다.", { quiet: 80, clarity: 50, presence: 45 }),
      answer("C", "등장하면 주변 분위기가 달라진다", { quiet: 35, clarity: 75, presence: 75 }),
      answer("D", "등장부터 시끄럽고 존재감이 강하다.", { quiet: 5, clarity: 95, presence: 95 })
    ]
  },
  {
    id: "Q2", category: "", enabled: true, scope: "common", weight: 1,
    axisWeights: { quiet: 0.04, clarity: 0.06, tactile: 0.05, presence: 0.03 },
    question: "감정이 크게 흔들릴 때 어떻게 드러나는 편인가?",
    answers: [
      answer("A", "끝까지 티내지 않는다.", { quiet: 90, clarity: 20, tactile: 20, presence: 15 }),
      answer("B", "짧게 반응하고 선을 긋는다.", { quiet: 70, clarity: 75, tactile: 65, presence: 50 }),
      answer("C", "날카롭게 바로 반응한다.", { quiet: 25, clarity: 95, tactile: 75, presence: 70 }),
      answer("D", "감정을 크게 터뜨리고 주변까지 휩쓸리게 만든다.", { quiet: 5, clarity: 85, tactile: 90, presence: 100 })
    ]
  },
  {
    id: "Q3", category: "", enabled: true, scope: "common", weight: 1,
    ...
    answers: [
      ...
      answer("C", "기발한 아이디어를 떠올려 실행시킨다.", { speed: 90, weight: 20, smoothness: 70, clarity: 70 }),
      answer("D", "빠르고 군더더기 없이 정확하게 움직인다.", { speed: 95, weight: 40, smoothness: 80, clarity: 95 })
    ]
  },
  {
    ...
    answers: [
      ...
      answer("C", "은근히 장난을 건다.", { warmth: 75, smoothness: 65, tactile: 45, quiet: 45 }),
      answer("D", "까칠하고 선이 분명하다.", { warmth: 15, smoothness: 20, tactile: 85, quiet: 55 })
    ]
  },
  {
    id: "Q5", category: "", enabled: true, scope: "common", weight: 1,
  ...
  {
    id: "Q6", category: "", enabled: true, scope: "common", weight: 1,
    ...
    answers: [
      ...
      answer("B", "솔직하지만 전부 보여주지는 않는다", { quiet: 45, clarity: 75, presence: 60 }),
  ...
  {
    id: "Q7", category: "", enabled: true, scope: "common", weight: 1.2,
    axisWeights: { quiet: 1, clarity: 0.75, presence: 0.05, warmth: 0.04 },
    question: "이 캐릭터의 목소리 톤에 가까운 것은?",
    answers: [
      answer("A", "조용한 톤의 목소리", { quiet: 93, clarity: 30, presence: 15, warmth: 45 }),
      answer("B", "낮고 조곤조곤한 목소리", { quiet: 75, clarity: 50, presence: 30, warmth: 65 }),
      answer("C", "또렷하게 들리는 목소리", { quiet: 49, clarity: 75, presence: 55, warmth: 45 }),
      answer("D", "크고 시원시원한 톤의 목소리", { quiet: 11, clarity: 95, presence: 88, warmth: 35 })
    ]
  },
  {
    id: "Q8", category: "", enabled: true, scope: "common", weight: 1,
  ...
  {
    id: "Q9", category: "", enabled: true, scope: "common", weight: 1,
    axisWeights: { warmth: 1 },
    question: "캐릭터의 전체적인 인상의 온도는?",
    answers: [
      answer("A", "얼음처럼 차갑다.", { warmth: 10 }),
      answer("B", "서늘한 편이다.", { warmth: 35 }),
      answer("C", "온화하고 편안하다.", { warmth: 65 }),
      answer("D", "햇살처럼 따뜻하다.", { warmth: 90 })
    ]
  },
  {
    id: "Q10", category: "", enabled: true, scope: "common", weight: 1,
    axisWeights: { presence: 1, weight: 0.05, clarity: 0.1 },
    question: "이야기 속에서 이 캐릭터의 존재감으로 가장 어울리는 것은?",
    answers: [
      answer("A", "조용히 관찰하거나 도움을 준다.", { presence: 15, weight: 35, clarity: 35 }),
      answer("B", "눈에 띄지는 않아도 꾸준히 중심을 받친다.", { presence: 30, weight: 60, clarity: 55 }),
      answer("C", "자연스럽게 이야기의 중심에 선다.", { presence: 55, weight: 55, clarity: 75 }),
      answer("D", "등장하면 이야기 전체를 장악한다.", { presence: 88, weight: 65, clarity: 95 })
    ]
  },
  {
    id: "Q11", category: "", enabled: true, scope: "inner", weight: 1,
    axisWeights: { quiet: 0.04, weight: 0.04, speed: 0.07, tactile: 0.06, warmth: 0.04, clarity: 0.07, smoothness: 0.07, presence: 0.03 },
    question: "이 캐릭터를 오래 본 사람이 아는 모습은?",
    answers: [
      answer("A", "다정하고 주변을 잘 챙긴다.", { warmth: 95, tactile: 20, smoothness: 90, speed: 45, weight: 45, quiet: 65, clarity: 60, presence: 45 }),
      answer("B", "선을 분명하게 긋는다.", { warmth: 10, tactile: 90, smoothness: 25, speed: 55, weight: 75, quiet: 65, clarity: 85, presence: 65 }),
  ...
  {
    id: "Q12", category: "", enabled: true, scope: "common", weight: 1,
    axisWeights: { tactile: 1, smoothness: 1 },
    question: "불편한 일을 마주했을 때 어떻게 반응하는가?",
    answers: [
      answer("A", "직면하기보다 자연스럽게 흘려보낸다.", { tactile: 6, smoothness: 90 }),
      answer("B", "부드럽게 대하지만 선은 분명히 긋는다.", { tactile: 30, smoothness: 75 }),
      answer("C", "짧고 단호하게 선을 긋는다.", { tactile: 59, smoothness: 55 }),
      answer("D", "다시는 선을 넘지 못하도록 끊어낸다.", { tactile: 80, smoothness: 35 })
    ]
  },
  {
    id: "Q13", category: "", enabled: true, scope: "common", weight: 1,
    axisWeights: { speed: 1, weight: 0.05, smoothness: 0.5, clarity: 0.16 },
    question: "예상하지 못한 일이 생겼을 때 첫 반응은?",
    answers: [
      answer("A", "침착하게 상황을 파악한다.", { speed: 30, weight: 65 }),
      answer("B", "능숙하게 흐름을 바꾼다.", { speed: 50, smoothness: 90 }),
      answer("C", "누구도 생각지 못한 행동을 한다.", { speed: 75, weight: 25 }),
